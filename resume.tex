...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{DevOps}
      {Docker, Heroku, Azure DevOps, Azure App Service, MongoDB Atlas, Travis CI, AppVeyor}
  \resumeSubHeadingListEnd
