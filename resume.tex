...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \textbf{Responsibilities}: Development of both the client-side (Next.js) and the server-side (ASP.NET 5) software.
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Server-side development}
      {ASP.NET, Entity Framework Core, IdentityServer4, Node.js, Express.js, Hapi.js, GraphQL}
    ...
    \resumeSubItem{DevOps}
      {Docker, PaaS (Heroku, Netlify, Azure App Service), MongoDB Atlas, CI/CD, SSH, VPS services}
  \resumeSubHeadingListEnd
