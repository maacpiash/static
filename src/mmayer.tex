...
\geometry{left=1.5cm,right=10cm,marginparwidth=6.8cm,marginparsep=1.2cm,top=1.25cm,bottom=1cm}
...
\begin{itemize}
\item Coursework: Social Media Intelligence, Natural Language Understanding, Predictive Analysis, Advanced Machine Learning, Advanced Statistical Methods
\end{itemize}
\smallskip
...
\cvevent{\href{https://www.apollointl.com.au}{Apollo International}}{Software Engineer}{20 Apr 2021 -- 25 Jul 2022}{Sydney, Australia}
...
\cvevent{\href{http://www.northsouth.edu}{North South University}}{Research Assistant}{1 Nov 2016 -- 30 Apr 2018}{Dhaka, Bangladesh}
...
\smallskip
Stack: .NET Framework, Windows Forms.\\
\smallskip
