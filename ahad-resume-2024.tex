...
\usepackage[top=2.5cm, bottom=3cm, right=2.5cm, left=2.5cm, a4paper]{geometry}
...
\fancyfoot[RE,LO]{\small Last edited on \today. The latest version of this document may be found at \href{https://pia.sh/resume}{\underline{pia.sh/resume}}.}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Development of the frontend project using React.js, Redux.js,  Next.js, Material UI etc.}
        \resumeItem{Development of the backend project with ASP.NET Core, Entity Framework Core, PostgreSQL, Redis etc.}
        \resumeItem{Unit testing of the backend project using xUnit.}
        \resumeItem{Unit and end-to-end testing of the frontend project using Jest, React Testing Library, and Playwright.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{The \href{https://www.dsinnovators.com/projects/open-crvs}{\underline{OpenCRVS project}} (\href{https://www.dsinnovators.com/casestudies/open-crvs-2}{\underline{technical details}}, \href{https://github.com/opencrvs/opencrvs-core/commits?author=maacpiash}{\underline{commits}}).}
      \resumeItem{The full-stack solution of \href{https://www.dsinnovators.com/projects/olwel}{\underline{Olwel}}, a healthcare startup (\href{https://www.dsinnovators.com/casestudies/olwel-2}{\underline{technical details}}).}
      \resumeItemListEnd
      ...
      \resumeItemListStart
        ...
        \resumeItem{Addition of features and optimizations to the backend projects with Node.js, Hapi.js, MongoDB, GraphQL, Docker etc.}
        \resumeItem{Optimization of RethinkDB queries and database migration scripts.}
        \resumeItem{Composition of unit and end-to-end tests, using Jest, Enzyme, and Cypress.}
    \resumeItemListEnd

    \resumeSubheading
      {Research Assistant}{1 November 2016 -- 30 April 2018}
      {\href{http://www.northsouth.edu}{North South University}}{Dhaka, Bangladesh}
      \\ \vspace{8pt} Part-time employment under the Department of Environmental Science \& Management \href{http://www.northsouth.edu/academic/shls/esm/}{\underline{(website)}} for developing NODES, an airline management system that maximises resource utilization (\href{http://www.ipsnews.net/2017/05/flying-green-in-bangladesh}{\underline{relevant news article}}). \vspace{-6pt}
      \\ \vspace{6pt} Responsibilities: Development of the frontend software of NODES using Windows Forms (.NET).
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Master of Data Science}{October 2023 -- June 2024}
      {\href{https://spi.nsw.edu.au}{Sydney Polytechnic Institute}}{Sydney, NSW, Australia}
      \item Notable Coursework: Database Systems and Infrastructure, Machine Learning and Data Mining, Data Visualisation, Natural Language Processing and Applications, Big Data Infrastructure and Processing.
    \resumeSubheading
      ...
      \\ Notable Coursework: Data Structure and Algorithm, Software Engineering, Artificial Intelligence, Theory of Fuzzy Systems, Computer Graphics, Microprocessor Interfacing \& Embedded System (\href{https://github.com/maacpiash?tab=repositories&q=CSE}{\underline{Repositories on GitHub}}).
  \resumeSubHeadingListEnd
...
\section{Publications}
 \begin{itemize}[leftmargin=0in, label={}]
    \item{
      Rahman, N.S.M.R., \textbf{Chowdhury, M.A.A.}, Siraj, AA.N., Rahman, R.M., Karim, R., Alam, K.M.A. (2018). Selection of Most Suitable Secondary School Alternative by Multi-Criteria Fuzzy Analytic Hierarchy Process. Advances in Intelligent Systems and Computing, vol 833. Springer, Cham. \href{https://link.springer.com/chapter/10.1007/978-3-319-98678-4_29}{\underline{link}}} \item{
      Ashraf, S., Kadery, I., \textbf{Chowdhury, M.A.A.}, Mahbub, T.Z., Rahman, R.M. (2019). Fruit Image Classification by Convolutional Neural Networks. International Journal of Software Innovation (IJSI), Volume 7, Issue 4, Article 4. \href{https://www.igi-global.com/gateway/article/236206}{\underline{link}}} \item{
