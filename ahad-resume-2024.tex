...
\fancyfoot[RE,LO]{\footnotesize Last edited on \today. The latest version of this document is available at \href{https://pia.sh/resume}{\underline{pia.sh/resume}}.}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \\ \vspace{8pt} Part-time employment under the Department of Environmental Science \& Management (\href{http://www.northsouth.edu/academic/shls/esm/}{\underline{website}}) for developing NODES, an airline management system that maximises resource utilisation (\href{http://www.ipsnews.net/2017/05/flying-green-in-bangladesh}{\underline{news article}}). \vspace{-6pt}
      \\ \vspace{6pt} Responsibilities: Development of the frontend software of NODES with Windows Forms (.NET).
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \item Notable Coursework: Database Systems and Infrastructure, Machine Learning and Data Mining, Data Visualisation and Tools, Natural Language Processing and Applications, Big Data Infrastructure and Processing, Artificial Intelligence and Innovation, Professional Practice.
    \resumeSubheading
...
\section{Open Source Contributions}
  \begin{itemize}[leftmargin=0.75cm]
    \item{\href{https://github.com/ubuntu-mate/ubuntu-mate.org/pull/141}{\underline{ubuntu-mate/ubuntu-mate.org\#141}}: Add instructions to verify download on Windows.}
    \item{\href{https://github.com/sandoche/Darkmode.js/pull/9}{\underline{sandoche/Darkmode.js\#9}}: Simplify boolean expressions.}
    \item{\href{https://github.com/howtocode-dev/git.howtocode.dev/pull/21}{\underline{howtocode-dev/git.howtocode.dev\#21}}: Add chapters on `git log` and `git cherry-pick`.}
    \item{\href{https://github.com/NetDevPack/Security.Jwt/pull/44}{\underline{NetDevPack/Security.Jwt\#44}}: Fix the command for NuGet Package Manager console.}
  \end{itemize}
% \vspace{-16pt}
