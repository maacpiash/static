...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Addition of features and bug-fixes to the frontend projects, using React.js, Electron.js, Material UI, Redux.js etc.}
        \resumeItem{Addition features and optimizations to the backend projects, using Node.js, Hapi.js, MongoDB, GraphQL, Docker etc.}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \\ Notable Coursework: Data Structure and Algorithm, Software Engineering, Artificial Intelligence, Theory of Fuzzy Logic, Computer Graphics, Microprocessor Interfacing \& Embedded System (\href{https://github.com/maacpiash?tab=repositories&q=CSE}{\underline{Repositories on GitHub}}).
  \resumeSubHeadingListEnd
