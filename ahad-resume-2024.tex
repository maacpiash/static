  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Addition of features and optimizations to the backend projects with Node.js, Hapi.js, MongoDB, GraphQL, Socket.io, Docker etc.}
        \resumeItem{Optimization of RethinkDB queries and database migration scripts.}
        \resumeItem{Composition of unit and end-to-end tests, with Jest, Enzyme, and Cypress.}
    \resumeItemListEnd
